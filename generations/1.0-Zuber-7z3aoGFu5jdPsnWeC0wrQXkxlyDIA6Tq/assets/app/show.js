...
var readerDiv = document.querySelector("#reader");
...
function startCameraAndScanner() {
    if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
        ...
        videoElement.id = 'camera-video-feed';
        ...
        navigator.mediaDevices.getUserMedia({ video: { facingMode: "environment" } })
            ...
            .catch(function(err) {
                ...
                alert("Nie można uruchomić kamery. Upewnij się, że masz podłączoną kamerę i wyraziłeś zgodę.");
            });
    } else {
